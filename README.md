...
- 番号と色名を併記した固定8色パレット、全消去確認、7種類のサンプル
...
- localStorageによるドット絵・現在ステップ・QR変更の端末内保存
...
```bash
npm test          # 変換・カメラ読取ロジックのVitest 23件
